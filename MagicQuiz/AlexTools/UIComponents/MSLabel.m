...
- (NSArray *)stringsFromText:(NSString *)string {
    ...
    if([VSUtils isIPad])
    {
    if([string isEqualToString:@"\"We have an understanding.\""])
    {
        [slicedString addObject:string];
        return slicedString;
    }
    
    if([string isEqualToString:@"Prime Minister Boutros Ghali"])
    {
        [slicedString addObject:@"Prime Minister Boutros Ghali"];
        //[slicedString addObject:@"Ghali"];
        return slicedString;
    }
    }
