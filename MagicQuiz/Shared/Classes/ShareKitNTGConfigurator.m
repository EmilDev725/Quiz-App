...
@implementation ShareKitNTGConfigurator
...
- (NSString*)twitterConsumerKey {
	return @"Ybe8AsrsQO2WUgjYZQvQQ";
}

- (NSString*)twitterSecret {
	return @"wBaFUJMH86wXWnmttqcTTNuBV29PUVTGSgrZMPnV19I";
}
